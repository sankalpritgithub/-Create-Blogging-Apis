...
import com.Blog.Project.Related.SpringBoot.Repositories.CategoryRepo;
...
import com.Blog.Project.Related.SpringBoot.Services.PostService;



@Service
public class PostServiceImples implements PostService {
...
/*
    @Override
    public PostRemove getAllPost(Integer pageNumber, Integer pageSize, String sortBy, String sortDir) {

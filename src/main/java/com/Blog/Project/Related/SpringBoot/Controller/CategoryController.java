...
import com.Blog.Project.Related.SpringBoot.Services.CategoryService;
...
public class CategoryController {
  ...
  @PutMapping("/{catId}")
  public ResponseEntity<CategoryDto> updCategoryDto(@Valid @RequestBody CategoryDto categoryDto, @PathVariable Integer catId){
